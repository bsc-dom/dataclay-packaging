...
LABEL org.opencontainers.image.created=$BUILD_DATE \
      ...
      org.label-schema.docker.dockerfile="/docker/dsjava/alpine.Dockerfile"

# Healthcheck
COPY ./health_check.sh ${DATACLAY_HOME}/health/health_check.sh

# ================= SERVICE ==================== #
ENTRYPOINT ["sh", "entrypoints/dataclay-java-entry-point", "es.bsc.dataclay.dataservice.server.DataServiceSrv","--service"] 
